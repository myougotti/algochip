...
// since it does not change order. Returned for chainability.
...
export default function AlgoChip() {
  ...
  const startRace = () => {
    ...
    const genLeft = SORT_GENERATORS[leftAlgo](baseArray);
    const genRight = SORT_GENERATORS[rightAlgo](baseArray);
