...
export default function AlgoChip() {
  ...
  useEffect(() => {
    const color = darkMode ? "#d4d4d8" : "#3f3f46"; // zinc-300 / zinc-700
    drawBars(leftCanvasRef.current, baseArray, 100, color);
    drawBars(rightCanvasRef.current, baseArray, 100, color);
  }, [baseArray, darkMode]);

  const canRun = leftAlgo !== "" && rightAlgo !== "";
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { side: "left", ref: leftCanvasRef, algo: leftAlgo },
              { side: "right", ref: rightCanvasRef, algo: rightAlgo },
            ].map(({ side, ref, algo }) => (
              <div key={side}>
                <div
